...
const LocaleSwitch = ({ pageContext }) => {
  ...
  return (
    <div ref={select} className="relative ml-4 ">
      <button
        type="button"
        className="hover:bg-primary-50 focus:bg-primary-50 flex h-full w-20 cursor-pointer items-center justify-between rounded-md px-2 py-2 hover:text-primary-600 focus:text-primary-600 focus:outline-none"
            ...
            return (
              ...
              >
                <p
                  ...
                  className="hover:bg-primary-50 cursor-pointer rounded-md  p-2 text-center capitalize hover:text-primary-600 hover:text-primary-600"
                >
                  {locale}
                </p>
              </Link>
